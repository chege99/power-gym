...
if(isset($_POST['btnsavenew'])){
	...
	$plan= filter_var($_POST['plan'],FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
	$startdate= filter_var($_POST['startdate'],FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
	$paymentstatus= filter_var($_POST['paymentstatus'],FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
	...
	CreateMember($plan,$startdate,$paymentstatus,$firstname,$lastname,$email,$phone,$address);
/*
echo "string". $plan;
...
function CreateMember($plan,$startdate,$paymentstatus,$firstname,$lastname,$email,$phone,$address){
	require ("../php/dbcon.php");	
